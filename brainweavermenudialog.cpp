...
std::vector<std::string> ribi::braw::MenuDialog::GetVersionHistory() const noexcept
{
  ...
  {
    const auto w = GetVersionHistory1();
    std::copy(std::begin(w), std::end(w), std::back_inserter(v));
  }
  {
    const auto w = GetVersionHistory2();
    std::copy(std::begin(w), std::end(w), std::back_inserter(v));
  }
  return v;
}

std::vector<std::string> ribi::braw::MenuDialog::GetVersionHistory1() const noexcept
{
 return {
    "2012-06-17: Version 0.01: concept version of ProjectVanDenBogaart, "
      "using 'IronHide' style",
    ...
    "2012-10-28: Version 0.05: added Cluster and ConceptMap, added AutoSave, "
      "ClusterWidget and Cluster work okay, file I/O working okay",
    "2012-11-10: Version 0.06: added first working QtConceptMap",
    "2012-11-13: Version 0.07: added edges and helpers to QtConceptMap",
    "2012-11-15: Version 0.08: concepts on edges in QtConceptMap are editable, "
      "QtConceptMap always looks pretty",
    "2012-11-18: Version 0.09: added edges with arrowheads, "
      "deletion of nodes and edges possible, put help items in status bar",
    "2012-11-22: Version 0.10: editing of concepts and their examples, "
      "tools icon (doing nothing yet)",
    ...
    "2012-12-08: Version 0.16: use quadratic Bezier curve for relations, "
      "locations of moved relations are saved",
    ...
    "2012-12-26: Version 0.19: program overview works again, "
      "concept map widgets for editing, rating and displaying work fine",
    "2012-12-28: Version 0.20: got Wine execution working again, rating works partially",
    "2012-12-31: Version 0.21: fixed bugs in cluster dialog, "
      "added test concept dialog, temporarily removed concept maps",
    "2013-01-01: Version 0.22: added test node and edge dialogs, "
      "removed crosscompiler errors by replacing std::all_of by count_if",
    ...
    "2013-01-23: Version 0.28: allow ConceptMapEdit arrows having solitary focus, "
      "progress on printing",
    "2013-02-12: Version 0.29: changed name to Brainweaver, progress on printing",
    "2013-04-21: Version 0.30: shows sub-concepts maps in rating well, "
      "allows saving without going back to the main menu",
    "2013-05-04: Version 0.31: improved printing for student and assessor, "
      "first steps in implementing undo functionality",
    "2013-07-27: Version 0.32: first step in semi-automated rating mechanism",
    "2013-08-06: Version 0.33: added icons and artwork"
  };
}

std::vector<std::string> ribi::braw::MenuDialog::GetVersionHistory2() const noexcept
{
  return {
    "2013-08-18: Version 0.34: fixed file dialog",
    "2013-08-30: Version 0.35: fixed segmentation faults, "
      "replaced print dialogs by save file dialogs",
    ...
    "2013-09-21: Version 0.38: minor changes, added wordwrap in examples "
      "in concept map widgets",
    "2013-09-29: Version 0.39: minor changes, "
      "added wordwrap in examples in rate examples dialog"
    "2013-10-03: Version 0.40: minor changes, added wordwrap in some more player",
    "2013-12-29: Version 0.43: bugfixes, renaming, refactoring, "
      "preparing for undo functionality",
    "2013-12-31: Version 0.44: when tallying the relevancies of a concept its "
      "connected examples, the node names connected to the edges are displayed",
    ...
    "2014-05-18: Version 0.50: edges connected to center node have no label, "
      "that cannot be edited",
    "2015-10-02: Version 0.51: moved to own GitHub",
    "2016-01-17: Version 1.0: made most classes regular, removed signals, "
