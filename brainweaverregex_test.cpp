...
BOOST_AUTO_TEST_CASE(test_ribi_pvdb_regex_GetRegexMatches)
{
  ...
  //Bug 2016-04-09
  {
    const std::string s =
      ...
      "<complexity>-1</complexity><concreteness>-1</concreteness>"
      "<specificity>-1</specificity></concept><x>0</x><y>0</y>"
      "<is_center_node>1</is_center_node></node>\", regular=\"0\"];"
      "}</conceptmap><question>Focal question?</question>"
      "<student_name>Richel Bilderbeek</student_name>"
      "<version>0.4</version></file>"
    ;
